              ...
              <section>
                ...
                <section class="login_message">
                  ...
                  <img ref="captcha" class="get_verification"
                       src="./capture/6EF8.png" alt="captcha">
                </section>
              </section>
            </div>
...
<script>
import yanxuanTop from '@/base/yanxuanTop.vue'
export default {
  data () {
    return {
...
.get_verification .right_phone_number{
  color: #000;
}
.login_verification{
  position: relative;
...
.switch_button.on .switch_circle{
  position: absolute;
  top: -1px;
  left: -1px;
  width: 16px;
...
.switch_button.on .switch_circle .right{
